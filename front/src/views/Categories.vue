        ...
        <div class="content">
            ...
            <div class="d-flex justify-content-between px-5 mt-2 mb-3">
                ...
                <div class="col-2 text-end">
                    <button class="btn bg-gray rounded-3 text-white" data-bs-toggle="modal" data-bs-target="#modalRegisterCategorie"  @click="crearCategoria">
                        +
                    ...
                    <table class="table overflow-x-scroll">
                        ...
                        <tbody>
                            <tr v-for="categoria in categorias" :key="categoria.categoria_persona_id">
                                ...
                                <td><img :src="`http://localhost:3000/uploads/categories/${categoria.imagen}`" alt="Imagen de categoría" width="50" /></td>
                                <td>
                                ...
                                <button v-if="categoria.estado" @click="cambiarEstado(categoria.categoria_persona_id)" class="btn btn-danger btn-sm">
                                        <i class="fa fa-ban"></i>
                                </button>
        ...
        <div class="modal-dialog"> 
            <div class="modal-content modal-card"> 
                <div class="modal-header"> 
                    <h5 class="modal-title" id="modalRegisterCategorieLabel">{{ editMode ? 'Editar Categoría' : 'Crear Nueva Categoría' }}</h5> 
                ...
                <div class="modal-bodyr"> 
                    <form @submit.prevent="saveCategory">
                        ...
                        <div class="d-flex justify-content-center py-3"> 
                            <button type="submit" class="btn btn-orange rounded-5 w-75">{{ editMode ? 'Guardar Cambios' : 'Crear Categoría' }}</button> 
                        </div>
                    </form> 
                </div> 
            </div> 
...
onMounted(() => {
    obtenerCategorias();
    // Reinicializar el modal al cerrarlo 
...
const saveCategory = async () => {
    ...
    try {
        if (editMode.value) {
            ...
            await axios.put(`${BaseURL}/${categoriaEditada.value.categoria_persona_id}`, formData, {
                headers: {
        ...
        // Cerrar el modal y recargar las categorías
        obtenerCategorias();
        const modal = new bootstrap.Modal(document.getElementById('modalRegisterCategorie'));
        modal.hide(); // Cierra correctamente el modal }
    } catch (error) {
