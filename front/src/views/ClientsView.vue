...
<template>
  <main class="min-vh-100">
        ...
        <div class="d-flex">
          <div class="position-relative">
            <input
              ...
              v-model="name"
              @input="handleName"
              class="form-control focus-ring focus-ring-secondary"
              placeholder="Buscar por nombre"
            />
            <div class="custom-absolute">
              <img
                src="../assets/svg/search-svgrepo-com.svg"
    ...
    <div class="container mt-3">
      ...
      <div
        class="content mt-4 rounded-2 shadow animate__animated animate__fadeIn"
        v-if="clients.length == 0 && !isLoading"
      >
        <div class="alert alert-gray text-center py-3" role="alert">
          <img src="../assets/svg/alert-2-svgrepo-com.svg" width="20" /> No se encontraron
          talentos
        </div>
      </div>
    </div>
