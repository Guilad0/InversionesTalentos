  ...
  <div>
    ...
    <div v-if="rol == 'Cliente'|| rol == 'Inversionista' " class="d-flex justify-content-evenly">
      ...
      <div class="col-6 d-flex justify-content-center px-4">
        <div v-if="!formLoading" class="card  shadow w-75" >
          <div class="card-body">
        ...
        <div class="d-flex justify-content-between py-4">
          ...
          <div class="">
            ...
            <div class="offcanvas-header m-auto position-relative">
              ...
              <button type="button" class="btn text-light custom-close-abs" data-bs-dismiss="offcanvas"  @click="closeCanvas"><i class="fa-solid fa-xmark"></i>
              </button>
            </div>
